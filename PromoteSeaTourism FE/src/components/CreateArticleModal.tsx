...
import { CreateArticleRequest, ArticleImage } from "../types/article";
...
export default function CreateArticleModal({
  ...
  const [newImage, setNewImage] = useState<ArticleImage>({
    url: "",
    altText: "",
    caption: "",
    position: 0,
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-white text-sm">
                        ...
                        <div className="text-white/60">{img.altText}</div>
                      </div>
                      {img.isCover && (
